...
<div x-data='{text: true}'>
    ...
    <div class="w-full bg-white rounded p-4 shadow-box mt-4 prose md:prose-xl max-w-none">
        ...
        <div class="w-full text-center">
            <a href="#projects" x-show="text" x-on:click.prevent="text = false; $nextTick(() => window.location='#projects')" class="no-underline text-xxs md:text-base group bg-blue-auto hover:bg-red-400 hover:shadow-boxhvr p-2 hover:pb-4 shadow-box border-2 border-black"><span class="relative show-border">No time for talking, show me the projects!</span></a>
            <template x-if="!text">
                <div class="my-6">
                    <a href="#" x-on:click="text = true;" class="group no-underline text-xxs md:text-base bg-red-400 hover:bg-blue-auto hover:shadow-boxhvr p-2 hover:pb-4 shadow-box border-2 border-black"><span class="relative show-border">Show me the intro text again!</span></a>
                </div>
            </template>
        </div>
