import{t as E,a as r,F as c,j as t,G as w}from"./react-app-8af0de14.js";import{r as i,b as j,T,W as $,c as q,F as u,K as N,h as S,d as k}from"./vendor-65e31ccf.js";import"./lodash-0223fb8a.js";import"./bignumber-63705fc6.js";const M=({spaceInfo:n,sidebar:y,close:g,language:h,refreshSpace:C})=>{const l=i.useRef(null),[s,f]=i.useState("code"),[o,b]=j(E),d=(o==null?void 0:o[n.name])||"",m=e=>{b({...o,[n.name]:e})},[a,v]=i.useState(null),_=async()=>{let e=await w.request(k.gql`mutation UpdateSpace($spaceName: String!, $content: String!) {
