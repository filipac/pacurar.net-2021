import{t as j,a as r,F as c,j as t,G as w}from"./react-app-9748fdca.js";import{c as i,i as $,U as E,V as q,y as R,M as u,N,R as S,d as C}from"./vendor-4baf7309.js";import"./lodash-87d1c6bb.js";import"./bignumber-d824444f.js";const z=({spaceInfo:a,sidebar:g,close:y,language:h,refreshSpace:k})=>{const l=i.useRef(null),[o,f]=i.useState("code"),[n,v]=$(j),d=(n==null?void 0:n[a.name])||"",m=e=>{v({...n,[a.name]:e})},[s,b]=i.useState(null),_=async()=>{let e=await w.request(C.gql`mutation UpdateSpace($spaceName: String!, $content: String!) {
