import{t as F,a as r,F as c,j as t,G as w}from"./react-app-4b28141e.js";import{c as i,i as j,U as $,V as T,y as q,M as u,N,R as S,d as k}from"./vendor-4baf7309.js";import"./lodash-87d1c6bb.js";import"./bignumber-d824444f.js";const A=({spaceInfo:n,sidebar:y,close:g,language:h,refreshSpace:C})=>{const l=i.useRef(null),[s,f]=i.useState("code"),[o,v]=j(F),d=(o==null?void 0:o[n.name])||"",m=e=>{v({...o,[n.name]:e})},[a,b]=i.useState(null),_=async()=>{let e=await w.request(k.gql`mutation UpdateSpace($spaceName: String!, $content: String!) {
