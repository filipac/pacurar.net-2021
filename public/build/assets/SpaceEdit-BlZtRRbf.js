import{t as F,a as r,F as c,j as t,G as w}from"./react-app-DdKy85kH.js";import{r as i,b as j,U as $,X as T,c as q,N as u,O as N,f as S,d as k}from"./vendor-DZp4qUgB.js";import"./bignumber-L0kgG1Q3.js";import"./lodash-C-76dkfd.js";const M=({spaceInfo:n,sidebar:y,close:g,language:h,refreshSpace:C})=>{const l=i.useRef(null),[s,f]=i.useState("code"),[o,b]=j(F),d=(o==null?void 0:o[n.name])||"",m=e=>{b({...o,[n.name]:e})},[a,v]=i.useState(null),_=async()=>{let e=await w.request(k.gql`mutation UpdateSpace($spaceName: String!, $content: String!) {
