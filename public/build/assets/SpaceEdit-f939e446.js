import{t as F,a as r,F as c,j as t,G as w}from"./react-app-7c47b6b5.js";import{r as i,b as j,P as T,T as $,c as q,K as u,L as N,f as S,d as k}from"./vendor-76713984.js";import"./bignumber-c60c4193.js";import"./lodash-42dc8045.js";const M=({spaceInfo:n,sidebar:y,close:g,language:h,refreshSpace:C})=>{const l=i.useRef(null),[s,f]=i.useState("code"),[o,b]=j(F),d=(o==null?void 0:o[n.name])||"",m=e=>{b({...o,[n.name]:e})},[a,v]=i.useState(null),_=async()=>{let e=await w.request(k.gql`mutation UpdateSpace($spaceName: String!, $content: String!) {
